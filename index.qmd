...
```{r chunk3, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
#### Table 2
```{r chunk4, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
library(shiny)
library(tidycensus)
library(tigris)
library(dplyr)
...
geo_counties <- counties(cb = TRUE, year = 2022)
